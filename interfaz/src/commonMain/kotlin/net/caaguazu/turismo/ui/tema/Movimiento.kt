 ...
 *
 * Cada plataforma lo dice a su manera —en Android es la escala de duracion de
 * animaciones, en iOS es "Reducir movimiento" de Accesibilidad— y `Sistema`
 * traduce las dos a la misma pregunta.
 */
val AnimacionesActivas: ProvidableCompositionLocal<Boolean> = compositionLocalOf { true }

@Composable
fun recordarAnimacionesActivas(): Boolean = remember { Sistema.animacionesActivas() }
