...
class SistemaDeDisenoTest {
    ...
    private val fuentes: List<File> by lazy { FuentesDelProyecto.deInterfaz() }
    ...
    fun `la paleta cubre los dos modos`() {
        val tokens = File("src/commonMain/kotlin/net/caaguazu/turismo/ui/tema/Tokens.kt").readText()
